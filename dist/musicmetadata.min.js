...
},{"./type":"2Fe+","buffer":"z1tx"}],"jSD1":[function(require,module,exports) {
...
},{"./support/isBuffer":"jSD1","inherits":"3F8I","process":"g5I+"}],"g2FE":[function(require,module,exports) {
var global = arguments[3];
...
},{"util/":"wqTM"}],"3mbL":[function(require,module,exports) {
...
},{"assert":"g2FE","./Windows1292Decoder":"0BDm"}],"1rOY":[function(require,module,exports) {
...
},{"assert":"g2FE"}],"O0hF":[function(require,module,exports) {
...
"use strict";var e=this&&this.__awaiter||function(e,t,o,a){return new(o||(o=Promise))(function(r,n){function i(e){try{c(a.next(e))}catch(t){n(t)}}function s(e){try{c(a.throw(e))}catch(t){n(t)}}function c(e){e.done?r(e.value):new o(function(t){t(e.value)}).then(i,s)}c((a=a.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("debug"),o=require("../common/Util"),a=require("token-types"),r=require("../common/BasicParser"),n=t("music-metadata:parser:ID3v1");exports.Genres=["Blues","Classic Rock","Country","Dance","Disco","Funk","Grunge","Hip-Hop","Jazz","Metal","New Age","Oldies","Other","Pop","R&B","Rap","Reggae","Rock","Techno","Industrial","Alternative","Ska","Death Metal","Pranks","Soundtrack","Euro-Techno","Ambient","Trip-Hop","Vocal","Jazz+Funk","Fusion","Trance","Classical","Instrumental","Acid","House","Game","Sound Clip","Gospel","Noise","Alt. Rock","Bass","Soul","Punk","Space","Meditative","Instrumental Pop","Instrumental Rock","Ethnic","Gothic","Darkwave","Techno-Industrial","Electronic","Pop-Folk","Eurodance","Dream","Southern Rock","Comedy","Cult","Gangsta Rap","Top 40","Christian Rap","Pop/Funk","Jungle","Native American","Cabaret","New Wave","Psychedelic","Rave","Showtunes","Trailer","Lo-Fi","Tribal","Acid Punk","Acid Jazz","Polka","Retro","Musical","Rock & Roll","Hard Rock","Folk","Folk/Rock","National Folk","Swing","Fast-Fusion","Bebob","Latin","Revival","Celtic","Bluegrass","Avantgarde","Gothic Rock","Progressive Rock","Psychedelic Rock","Symphonic Rock","Slow Rock","Big Band","Chorus","Easy Listening","Acoustic","Humour","Speech","Chanson","Opera","Chamber Music","Sonata","Symphony","Booty Bass","Primus","Porn Groove","Satire","Slow Jam","Club","Tango","Samba","Folklore","Ballad","Power Ballad","Rhythmic Soul","Freestyle","Duet","Punk Rock","Drum Solo","A Cappella","Euro-House","Dance Hall","Goa","Drum & Bass","Club-House","Hardcore","Terror","Indie","BritPop","Negerpunk","Polsk Punk","Beat","Christian Gangsta Rap","Heavy Metal","Black Metal","Crossover","Contemporary Christian","Christian Rock","Merengue","Salsa","Thrash Metal","Anime","JPop","Synthpop","Abstract","Art Rock","Baroque","Bhangra","Big Beat","Breakbeat","Chillout","Downtempo","Dub","EBM","Eclectic","Electro","Electroclash","Emo","Experimental","Garage","Global","IDM","Illbient","Industro-Goth","Jam Band","Krautrock","Leftfield","Lounge","Math Rock","New Romantic","Nu-Breakz","Post-Punk","Post-Rock","Psytrance","Shoegaze","Space Rock","Trop Rock","World Music","Neoclassical","Audiobook","Audio Theatre","Neue Deutsche Welle","Podcast","Indie Rock","G-Funk","Dubstep","Garage Rock","Psybient"];const i={len:128,get:(e,t)=>{const o=new s(3).get(e,t);return"TAG"===o?{header:o,title:new s(30).get(e,t+3),artist:new s(30).get(e,t+33),album:new s(30).get(e,t+63),year:new s(4).get(e,t+93),comment:new s(28).get(e,t+97),zeroByte:a.UINT8.get(e,t+127),track:a.UINT8.get(e,t+126),genre:a.UINT8.get(e,t+127)}:null}};class s extends a.StringType{constructor(e){super(e,"binary")}get(e,t){let a=super.get(e,t);return(a=(a=o.default.trimRightNull(a)).trim()).length>0?a:void 0}}class c extends r.BasicParser{static getGenre(e){if(e<exports.Genres.length)return exports.Genres[e]}parse(){return e(this,void 0,void 0,function*(){if(!this.tokenizer.fileSize)return void n("Skip checking for ID3v1 because the file-size is unknown");const e=this.tokenizer.fileSize-i.len;if(this.tokenizer.position>e)return void n("Already consumed the last 128 bytes");const t=yield this.tokenizer.readToken(i,e);if(t){n("ID3v1 header found at: pos=%s",this.tokenizer.fileSize-i.len);for(const o of["title","artist","album","comment","track","year"])t[o]&&""!==t[o]&&this.addTag(o,t[o]);const e=c.getGenre(t.genre);e&&this.addTag("genre",e)}else n("ID3v1 header not found at: pos=%s",this.tokenizer.fileSize-i.len)})}addTag(e,t){this.metadata.addTag("ID3v1",e,t)}}exports.ID3v1Parser=c;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const i=require("debug"),t=require("./GenericTagTypes"),e=require("./CombinedTagMapper"),a=require("./GenericTagMapper"),s=i("music-metadata:collector"),o=["APEv2","vorbis","ID3v2.4","ID3v2.3","ID3v2.2","exif","asf","iTunes","ID3v1"];class r{constructor(i){this.opts=i,this.format={tagTypes:[]},this.native={},this.common={track:{no:null,of:null},disk:{no:null,of:null}},this.commonOrigin={},this.originPriority={},this.tagMapper=new e.CombinedTagMapper;let t=1;for(const e of o)this.originPriority[e]=t++;this.originPriority.artificial=500,this.originPriority.id3v1=600}hasAny(){for(const i in this.native)return!0;return!1}setFormat(i,t){s(`format: ${i} = ${t}`),this.format[i]=t,this.opts.observer&&this.opts.observer({metadata:this,tag:{type:"format",id:i,value:t}})}addTag(i,t,e){s(`tag ${i}.${t} = ${e}`),this.native[i]||(this.format.tagTypes.push(i),this.native[i]=[]),this.native[i].push({id:t,value:e}),this.toCommon(i,t,e)}getNativeMetadata(){return{format:this.format,native:this.native}}postMap(i,t){switch(t.id){case"artist":if(this.commonOrigin.artist===this.originPriority[i])return this.postMap("artificial",{id:"artists",value:t.value});this.common.artists||this.setGenericTag("artificial",{id:"artists",value:t.value});break;case"artists":if(!(this.common.artist&&this.commonOrigin.artist!==this.originPriority.artificial||this.common.artists&&-1!==this.common.artists.indexOf(t.value))){const i={id:"artist",value:n((this.common.artists||[]).concat([t.value]))};this.setGenericTag("artificial",i)}break;case"genre":t.value=a.CommonTagMapper.parseGenre(t.value);break;case"picture":t.value.format=a.CommonTagMapper.fixPictureMimeType(t.value.format);break;case"totaltracks":return void(this.common.track.of=a.CommonTagMapper.toIntOrNull(t.value));case"totaldiscs":return void(this.common.disk.of=a.CommonTagMapper.toIntOrNull(t.value));case"track":case"disk":const e=this.common[t.id].of;return this.common[t.id]=a.CommonTagMapper.normalizeTrack(t.value),void(this.common[t.id].of=null!=e?e:this.common[t.id].of);case"year":case"originalyear":t.value=parseInt(t.value,10);break;case"date":const s=parseInt(t.value.substr(0,4),10);s&&!isNaN(s)&&(this.common.year=s);break;case"discogs_label_id":case"discogs_release_id":case"discogs_master_release_id":case"discogs_artist_id":case"discogs_votes":t.value="string"==typeof t.value?parseInt(t.value,10):t.value;break;case"replaygain_track_peak":t.value="string"==typeof t.value?parseFloat(t.value):t.value;break;case"gapless":t.value="1"===t.value}this.setGenericTag(i,t)}toCommonMetadata(){return{format:this.format,native:this.opts.native?this.native:void 0,common:this.common}}toCommon(i,t,e){const a={id:t,value:e},s=this.tagMapper.mapTag(i,a);s&&this.postMap(i,s)}setGenericTag(i,e){s(`common.${e.id} = ${e.value}`);const a=this.commonOrigin[e.id]||1e3,o=this.originPriority[i];if(t.isSingleton(e.id)){if(!(o<=a))return s(`Ignore native tag (singleton): ${i}.${e.id} = ${e.value}`);this.common[e.id]=e.value,this.commonOrigin[e.id]=o}else if(o===a)t.isUnique(e.id)&&-1!==this.common[e.id].indexOf(e.value)?s(`Ignore duplicate value: ${i}.${e.id} = ${e.value}`):this.common[e.id].push(e.value);else{if(!(o<a))return s(`Ignore native tag (list): ${i}.${e.id} = ${e.value}`);this.common[e.id]=[e.value],this.commonOrigin[e.id]=o}this.opts.observer&&this.opts.observer({metadata:this,tag:{type:"common",id:e.id,value:e.value}})}}function n(i){return i.length>2?i.slice(0,i.length-1).join(", ")+" & "+i[i.length-1]:i.join(" & ")}exports.MetadataCollector=r,exports.joinArtists=n;
},{"debug":"j+D9","./GenericTagTypes":"Wlj4","./CombinedTagMapper":"CeTJ","./GenericTagMapper":"QsE/"}],"GKOa":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("token-types"),s=require("assert"),t=require("../common/FourCC");class n{constructor(e,t){this.isAifc=t;const n=t?22:18;s.ok(e.chunkSize>=n,`COMMON CHUNK size should always be at least ${n}`),this.len=e.chunkSize}get(s,n){const r=s.readUInt16BE(n+8)-16398,o=s.readUInt16BE(n+8+2),i={numChannels:s.readUInt16BE(n),numSampleFrames:s.readUInt32BE(n+2),sampleSize:s.readUInt16BE(n+6),sampleRate:r<0?o>>Math.abs(r):o<<r};if(this.isAifc){if(i.compressionType=t.FourCcToken.get(s,n+18),this.len>22){const t=s.readInt8(n+22);if(23+t+(t+1)%2!==this.len)throw new Error("Illegal pstring length");i.compressionName=new e.StringType(t,"binary").get(s,n+23)}}else i.compressionName="PCM";return i}}exports.Common=n;
},{"token-types":"1rOY","assert":"g2FE","../common/FourCC":"P2sd"}],"rTYW":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("../common/FourCC");exports.Header={len:8,get:(r,o)=>({chunkID:e.FourCcToken.get(r,o),chunkSize:r.readUInt32BE(o+4)})};
...
},{"process-nextick-args":"iFTO","core-util-is":"kj8s","inherits":"3F8I","util-deprecate":"hQaz","./internal/streams/stream":"o232","safe-buffer":"gI/y","./internal/streams/destroy":"Umu+","./_stream_duplex":"6gYn","process":"g5I+"}],"6gYn":[function(require,module,exports) {
...
},{"process-nextick-args":"iFTO","core-util-is":"kj8s","inherits":"3F8I","./_stream_readable":"KTao","./_stream_writable":"pX9p"}],"jreP":[function(require,module,exports) {
...
},{"process-nextick-args":"iFTO","isarray":"aq/z","events":"wIHY","./internal/streams/stream":"o232","safe-buffer":"gI/y","core-util-is":"kj8s","inherits":"3F8I","util":"sC8V","./internal/streams/BufferList":"m36/","./internal/streams/destroy":"Umu+","./_stream_duplex":"6gYn","string_decoder/":"jreP","process":"g5I+"}],"PxOV":[function(require,module,exports) {
...
},{"./_stream_duplex":"6gYn","core-util-is":"kj8s","inherits":"3F8I"}],"pumY":[function(require,module,exports) {
...
},{"./_stream_transform":"PxOV","core-util-is":"kj8s","inherits":"3F8I"}],"17Yv":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("stream");class s extends e.Readable{constructor(e){super(),this.buf=e}_read(){this.push(this.buf),this.push(null)}}exports.ID3Stream=s;
},{"stream":"17Yv"}],"C2dR":[function(require,module,exports) {
"use strict";var e=this&&this.__awaiter||function(e,t,a,r){return new(a||(a=Promise))(function(s,i){function n(e){try{m(r.next(e))}catch(t){i(t)}}function o(e){try{m(r.throw(e))}catch(t){i(t)}}function m(e){e.done?s(e.value):new a(function(t){t(e.value)}).then(n,o)}m((r=r.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("token-types"),a=require("debug"),r=require("strtok3/lib/type"),s=require("strtok3/lib/core"),i=require("../id3v2/ID3v2Parser"),n=require("../common/FourCC"),o=require("../common/BasicParser"),m=require("./AiffToken"),d=require("../iff"),u=require("../id3v2/ID3Stream"),h=a("music-metadata:parser:aiff");class c extends o.BasicParser{parse(){return e(this,void 0,void 0,function*(){if("FORM"!==(yield this.tokenizer.readToken(d.Header)).chunkID)throw new Error("Invalid Chunk-ID, expected 'FORM'");const e=yield this.tokenizer.readToken(n.FourCcToken);switch(e){case"AIFF":this.metadata.setFormat("dataformat",e),this.isCompressed=!1;break;case"AIFC":this.metadata.setFormat("dataformat","AIFF-C"),this.isCompressed=!0;break;default:throw Error("Unsupported AIFF type: "+e)}this.metadata.setFormat("lossless",!this.isCompressed);try{for(;;){const e=yield this.tokenizer.readToken(d.Header);h(`Chunk id=${e.chunkID}`);const t=2*Math.round(e.chunkSize/2),a=yield this.readData(e);yield this.tokenizer.ignore(t-a)}}catch(t){if(t.message!==r.endOfFile)throw t}})}readData(a){return e(this,void 0,void 0,function*(){switch(a.chunkID){case"COMM":const e=yield this.tokenizer.readToken(new m.Common(a,this.isCompressed));return this.metadata.setFormat("bitsPerSample",e.sampleSize),this.metadata.setFormat("sampleRate",e.sampleRate),this.metadata.setFormat("numberOfChannels",e.numChannels),this.metadata.setFormat("numberOfSamples",e.numSampleFrames),this.metadata.setFormat("duration",e.numSampleFrames/e.sampleRate),this.metadata.setFormat("encoder",e.compressionName),a.chunkSize;case"ID3 ":const r=yield this.tokenizer.readToken(new t.BufferType(a.chunkSize)),n=new u.ID3Stream(r),o=s.fromStream(n);return yield(new i.ID3v2Parser).parse(this.metadata,o,this.options),a.chunkSize;case"SSND":return this.metadata.format.duration&&this.metadata.setFormat("bitrate",8*a.chunkSize/this.metadata.format.duration),0;default:return 0}})}}exports.AIFFParser=c;
...
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer,t=this&&this.__awaiter||function(e,t,a,r){return new(a||(a=Promise))(function(i,s){function o(e){try{d(r.next(e))}catch(t){s(t)}}function n(e){try{d(r.throw(e))}catch(t){s(t)}}function d(e){e.done?i(e.value):new a(function(t){t(e.value)}).then(o,n)}d((r=r.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const a=require("debug"),r=require("file-type"),i=require("token-types"),s=require("assert"),o=require("../common/Util"),n=require("../common/BasicParser"),d=require("./APEv2Token"),l=a("music-metadata:parser:APEv2"),c="APEv2",p="APETAGEX";class f extends n.BasicParser{constructor(){super(...arguments),this.ape={}}static calculateDuration(e){let t=e.totalFrames>1?e.blocksPerFrame*(e.totalFrames-1):0;return(t+=e.finalFrameBlocks)/e.sampleRate}static parseTagHeader(a,r,i){return t(this,void 0,void 0,function*(){if(r.fileSize&&r.fileSize-r.position<d.TagFooter.len)return void l("No APEv2 header found, end-of-file reached");const t=yield r.peekToken(d.TagFooter);if(t.ID===p){yield r.ignore(d.TagFooter.len);const e=yield r.readToken(d.TagField(t));f.parseTags(a,t,e,0,!i.skipCovers)}else if(l(`APEv2 header not found at offset=${r.position}`),r.fileSize){const t=r.fileSize-r.position,s=e.alloc(t);return yield r.readBuffer(s),f.parseTagFooter(a,s,!i.skipCovers)}})}static parseTagFooter(e,t,a){const r=d.TagFooter.get(t,t.length-d.TagFooter.len);s.equal(r.ID,p,"APEv2 Footer preamble"),this.parseTags(e,r,t,t.length-r.size,a)}static parseTags(t,a,i,s,n){for(let p=0;p<a.fields;p++){const a=d.TagItemHeader.get(i,s);s+=d.TagItemHeader.len;let p=o.default.findZero(i,s,i.length);const f=i.toString("ascii",s,p);switch(s=p+1,a.flags.dataType){case d.DataType.text_utf8:{const e=i.toString("utf8",s,s+=a.size).split(/\x00/g);for(const a of e)t.addTag(c,f,a);break}case d.DataType.binary:if(n){const n=i.slice(s,s+a.size);let d=0;p=o.default.findZero(n,d,n.length);const u=n.toString("utf8",d,p);d=p+1;const m=e.from(n.slice(d)),h=r(m);if(h)if(0===h.mime.indexOf("image/")){const e={description:u,data:m,format:h.mime};s+=a.size,t.addTag(c,f,e)}else l(`Unexpected binary tag of type': ${h.mime}`);else l(`Failed to determine file type for binary tag: ${f}`)}break;case d.DataType.external_info:l(`Ignore external info ${f}`);break;default:throw new Error(`Unexpected data-type: ${a.flags.dataType}`)}}}parse(){return t(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(d.DescriptorParser);s.equal(e.ID,"MAC ","descriptor.ID"),this.ape.descriptor=e;const t=e.descriptorBytes-d.DescriptorParser.len,a=yield t>0?this.parseDescriptorExpansion(t):this.parseHeader();return yield this.tokenizer.readToken(new i.IgnoreType(a.forwardBytes)),f.parseTagHeader(this.metadata,this.tokenizer,this.options)})}parseDescriptorExpansion(e){return t(this,void 0,void 0,function*(){return yield this.tokenizer.readToken(new i.IgnoreType(e)),this.parseHeader()})}parseHeader(){return t(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(d.Header);return this.metadata.setFormat("lossless",!0),this.metadata.setFormat("dataformat","Monkey's Audio"),this.metadata.setFormat("bitsPerSample",e.bitsPerSample),this.metadata.setFormat("sampleRate",e.sampleRate),this.metadata.setFormat("numberOfChannels",e.channel),this.metadata.setFormat("duration",f.calculateDuration(e)),{forwardBytes:this.ape.descriptor.seekTableBytes+this.ape.descriptor.headerDataBytes+this.ape.descriptor.apeFrameDataBytes+this.ape.descriptor.terminatingDataBytes}})}}exports.APEv2Parser=f;
},{"debug":"j+D9","file-type":"gPQA","token-types":"1rOY","assert":"g2FE","../common/Util":"5e0M","../common/BasicParser":"O0hF","./APEv2Token":"xQQP","buffer":"z1tx"}],"SsVx":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
...
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer;Object.defineProperty(exports,"__esModule",{value:!0});const t=require("../common/Util"),r=require("token-types"),a=require("./GUID"),s=require("./AsfUtil"),n=require("../id3v2/ID3v2");var o;!function(e){e[e.UnicodeString=0]="UnicodeString",e[e.ByteArray=1]="ByteArray",e[e.Bool=2]="Bool",e[e.DWord=3]="DWord",e[e.QWord=4]="QWord",e[e.Word=5]="Word"}(o=exports.DataType||(exports.DataType={})),exports.TopLevelHeaderObjectToken={len:30,get:(e,t)=>({objectId:a.default.fromBin(new r.BufferType(16).get(e,t)),objectSize:r.UINT64_LE.get(e,t+16),numberOfHeaderObjects:r.UINT32_LE.get(e,t+24)})},exports.HeaderObjectToken={len:24,get:(e,t)=>({objectId:a.default.fromBin(new r.BufferType(16).get(e,t)),objectSize:r.UINT64_LE.get(e,t+16)})};class i{constructor(e){this.len=e.objectSize-exports.HeaderObjectToken.len}postProcessTag(e,t,r,a){if("WM/Picture"===t)e.push({id:t,value:T.fromBuffer(a)});else{const n=s.AsfUtil.getParserForAttr(r);if(!n)throw new Error("unexpected value headerType: "+r);e.push({id:t,value:n(a)})}}}exports.State=i;class c extends i{constructor(e){super(e)}get(e,t){return null}}exports.IgnoreObjectState=c;class d extends i{constructor(e){super(e)}get(e,s){return{fileId:a.default.fromBin(e,s),fileSize:r.UINT64_LE.get(e,s+16),creationDate:r.UINT64_LE.get(e,s+24),dataPacketsCount:r.UINT64_LE.get(e,s+32),playDuration:r.UINT64_LE.get(e,s+40),sendDuration:r.UINT64_LE.get(e,s+48),preroll:r.UINT64_LE.get(e,s+56),flags:{broadcast:t.default.strtokBITSET.get(e,s+64,24),seekable:t.default.strtokBITSET.get(e,s+64,25)},minimumDataPacketSize:r.UINT32_LE.get(e,s+68),maximumDataPacketSize:r.UINT32_LE.get(e,s+72),maximumBitrate:r.UINT32_LE.get(e,s+76)}}}d.guid=a.default.FilePropertiesObject,exports.FilePropertiesObject=d;class u extends i{constructor(e){super(e)}get(e,t){return{streamType:a.default.decodeMediaType(a.default.fromBin(e,t)),errorCorrectionType:a.default.fromBin(e,t+8)}}}u.guid=a.default.StreamPropertiesObject,exports.StreamPropertiesObject=u;class l{constructor(){this.len=22}get(e,t){e.readUInt32LE(t+18);return{reserved1:a.default.fromBin(e,t),reserved2:e.readUInt16LE(t+16),extensionDataSize:e.readUInt32LE(t+18)}}}l.guid=a.default.HeaderExtensionObject,exports.HeaderExtensionObject=l;class f extends i{constructor(e){super(e)}get(e,t){const r=[];let a=t+10;for(let n=0;n<f.contentDescTags.length;++n){const o=e.readUInt16LE(t+2*n);if(o>0){const t=f.contentDescTags[n],i=a+o;r.push({id:t,value:s.AsfUtil.parseUnicodeAttr(e.slice(a,i))}),a=i}}return r}}f.guid=a.default.ContentDescriptionObject,f.contentDescTags=["Title","Author","Copyright","Description","Rating"],exports.ContentDescriptionObjectState=f;class p extends i{constructor(e){super(e)}get(e,t){const r=[],a=e.readUInt16LE(t);let n=t+2;for(let o=0;o<a;o+=1){const t=e.readUInt16LE(n);n+=2;const a=s.AsfUtil.parseUnicodeAttr(e.slice(n,n+t));n+=t;const o=e.readUInt16LE(n);n+=2;const i=e.readUInt16LE(n);n+=2;const c=e.slice(n,n+i);n+=i,this.postProcessTag(r,a,o,c)}return r}}p.guid=a.default.ExtendedContentDescriptionObject,exports.ExtendedContentDescriptionObjectState=p;class g extends i{constructor(e){super(e)}get(e,a){return{startTime:r.UINT64_LE.get(e,a),endTime:r.UINT64_LE.get(e,a+8),dataBitrate:e.readInt32LE(a+12),bufferSize:e.readInt32LE(a+16),initialBufferFullness:e.readInt32LE(a+20),alternateDataBitrate:e.readInt32LE(a+24),alternateBufferSize:e.readInt32LE(a+28),alternateInitialBufferFullness:e.readInt32LE(a+32),maximumObjectSize:e.readInt32LE(a+36),flags:{reliableFlag:t.default.strtokBITSET.get(e,a+40,0),seekableFlag:t.default.strtokBITSET.get(e,a+40,1),resendLiveCleanpointsFlag:t.default.strtokBITSET.get(e,a+40,2)},streamNumber:e.readInt16LE(a+42),streamLanguageId:e.readInt16LE(a+44),averageTimePerFrame:e.readInt32LE(a+52),streamNameCount:e.readInt32LE(a+54),payloadExtensionSystems:e.readInt32LE(a+56),streamNames:[],streamPropertiesObject:null}}}g.guid=a.default.ExtendedStreamPropertiesObject,exports.ExtendedStreamPropertiesObjectState=g;class E extends i{constructor(e){super(e)}get(e,t){const r=[],a=e.readUInt16LE(t);let n=t+2;for(let o=0;o<a;o+=1){n+=4;const t=e.readUInt16LE(n);n+=2;const a=e.readUInt16LE(n);n+=2;const o=e.readUInt32LE(n);n+=4;const i=s.AsfUtil.parseUnicodeAttr(e.slice(n,n+t));n+=t;const c=e.slice(n,n+o);if(n+=o,!s.AsfUtil.getParserForAttr(a))throw new Error("unexpected value headerType: "+a);this.postProcessTag(r,i,a,c)}return r}}E.guid=a.default.MetadataObject,exports.MetadataObjectState=E;class I extends E{constructor(e){super(e)}}I.guid=a.default.MetadataLibraryObject,exports.MetadataLibraryObjectState=I;class T{constructor(e){this.len=e}static fromBase64(t){return this.fromBuffer(e.from(t,"base64"))}static fromBuffer(e){return new T(e.length).get(e,0)}get(e,t){const r=e.readUInt8(t++),a=e.readInt32LE(t);let s=5;for(;0!==e.readUInt16BE(s);)s+=2;const o=e.slice(5,s).toString("utf16le");for(;0!==e.readUInt16BE(s);)s+=2;const i=e.slice(5,s).toString("utf16le");return{type:n.AttachedPictureType[r],format:o,description:i,size:a,data:e.slice(s+4)}}}exports.WmPictureToken=T;
},{"../common/Util":"5e0M","token-types":"1rOY","./GUID":"SsVx","./AsfUtil":"VWU3","../id3v2/ID3v2":"GKOa","buffer":"z1tx"}],"EvYH":[function(require,module,exports) {
...
},{"token-types":"1rOY","../../id3v2/ID3v2":"GKOa","buffer":"z1tx"}],"Tc8M":[function(require,module,exports) {
...
},{"strtok3/lib/type":"2Fe+","./ID3v2":"GKOa","./ID3v2Parser":"pIqu","../id3v1/ID3v1Parser":"WTnS","debug":"j+D9","../common/BasicParser":"O0hF"}],"lnZi":[function(require,module,exports) {
...
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer,t=this&&this.__awaiter||function(e,t,a,r){return new(a||(a=Promise))(function(s,i){function n(e){try{d(r.next(e))}catch(t){i(t)}}function o(e){try{d(r.throw(e))}catch(t){i(t)}}function d(e){e.done?s(e.value):new a(function(t){t(e.value)}).then(n,o)}d((r=r.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const a=require("debug"),r=require("token-types"),s=require("../common/BasicParser"),i=require("./Atom"),n=require("./AtomToken"),o=require("../id3v1/ID3v1Parser"),d=a("music-metadata:parser:MP4"),h="iTunes",m={alac:{lossy:!1,format:"ALAC"},mp4a:{lossy:!0,format:"MP4A"},mp4s:{lossy:!0,format:"MP4S"},c608:{lossy:!0,format:"CEA-608"},c708:{lossy:!0,format:"CEA-708"}};function c(e,t,a){return a.indexOf(e)===t}class u extends s.BasicParser{static read_BE_Signed_Integer(e){return r.readIntBE(e,0,e.length)}static read_BE_Unsigned_Integer(e){return r.readUIntBE(e,0,e.length)}parse(){return t(this,void 0,void 0,function*(){this.formatList=[];const e=new i.Atom({name:"mp4",length:this.tokenizer.fileSize},!1,null);yield e.readAtoms(this.tokenizer,e=>t(this,void 0,void 0,function*(){if(e.parent)switch(e.parent.header.name){case"ilst":case"<id>":return this.parseMetadataItemData(e);case"stbl":switch(e.header.name){case"stsd":return this.parseAtom_stsd(e.dataLen)}}switch(e.header.name){case"ftyp":const t=yield this.parseAtom_ftyp(e.dataLen);return d(`ftyp: ${t.join("/")}`),void this.metadata.setFormat("dataformat",t.filter(c).join("/"));case"mdhd":return this.parseAtom_mdhd(e);case"mvhd":return this.parseAtom_mvhd(e);case"mdat":this.tokenizer.fileSize&&this.metadata.format.duration&&this.metadata.setFormat("bitrate",8*e.dataLen/this.metadata.format.duration)}yield this.tokenizer.readToken(new r.IgnoreType(e.dataLen)),d(`Ignore atom data: path=${e.atomPath}, payload-len=${e.dataLen}`)}),this.tokenizer.fileSize),this.metadata.setFormat("encoder",this.formatList.filter(c).join("+"))})}addTag(e,t){this.metadata.addTag(h,e,t)}addWarning(e){d("Warning:"+e),this.warnings.push(e)}parseMetadataItemData(e){let a=e.header.name;return e.readAtoms(this.tokenizer,e=>t(this,void 0,void 0,function*(){switch(e.header.name){case"data":return this.parseValueAtom(a,e);case"name":const t=yield this.tokenizer.readToken(new n.NameAtom(e.dataLen));a+=":"+t.name;break;case"mean":const s=yield this.tokenizer.readToken(new n.NameAtom(e.dataLen));a+=":"+s.name;break;default:const i=yield this.tokenizer.readToken(new r.BufferType(e.dataLen));this.addWarning("Unsupported meta-item: "+a+"["+e.header.name+"] => value="+i.toString("hex")+" ascii="+i.toString("ascii"))}}),e.dataLen)}parseValueAtom(a,s){return t(this,void 0,void 0,function*(){const t=yield this.tokenizer.readToken(new n.DataAtom(s.header.length-n.Header.len));if(0!==t.type.set)throw new Error("Unsupported type-set != 0: "+t.type.set);switch(t.type.type){case 0:switch(a){case"trkn":case"disk":const e=r.UINT8.get(t.value,3),s=r.UINT8.get(t.value,5);this.addTag(a,e+"/"+s);break;case"gnre":const i=r.UINT8.get(t.value,1),n=o.Genres[i-1];this.addTag(a,n)}break;case 1:case 18:this.addTag(a,t.value.toString("utf-8"));break;case 13:if(this.options.skipCovers)break;this.addTag(a,{format:"image/jpeg",data:e.from(t.value)});break;case 14:if(this.options.skipCovers)break;this.addTag(a,{format:"image/png",data:e.from(t.value)});break;case 21:this.addTag(a,u.read_BE_Signed_Integer(t.value));break;case 22:this.addTag(a,u.read_BE_Unsigned_Integer(t.value));break;case 65:this.addTag(a,t.value.readInt8(0));break;case 66:this.addTag(a,t.value.readInt16BE(0));break;case 67:this.addTag(a,t.value.readInt32BE(0));break;default:this.addWarning(`atom key=${a}, has unknown well-known-type (data-type): ${t.type.type}`)}})}parseAtom_mvhd(e){return t(this,void 0,void 0,function*(){const t=yield this.tokenizer.readToken(new n.MvhdAtom(e.dataLen));this.parse_mxhd(t)})}parseAtom_mdhd(e){return t(this,void 0,void 0,function*(){const t=yield this.tokenizer.readToken(new n.MdhdAtom(e.dataLen));this.parse_mxhd(t)})}parse_mxhd(e){if(e.timeScale&&(this.metadata.setFormat("sampleRate",e.timeScale),!this.metadata.format.duration)){const t=e.duration/e.timeScale;this.metadata.setFormat("duration",t)}}parseAtom_ftyp(e){return t(this,void 0,void 0,function*(){const t=yield this.tokenizer.readToken(n.ftyp);if((e-=n.ftyp.len)>0){const a=yield this.parseAtom_ftyp(e),r=t.type.replace(/\W/g,"");return r.length>0&&a.push(r),a}return[]})}parseAtom_stsd(e){return t(this,void 0,void 0,function*(){const t=yield this.tokenizer.readToken(new n.StsdAtom(e)),a=[];for(const e of t.table){const t=m[e.dataFormat];t?(this.metadata.setFormat("lossless",!t.lossy),a.push(t.format)):(d(`Warning: data-format '${e.dataFormat}' missing in MP4Parser.encoderDict`),a.push(e.dataFormat))}this.formatList.push(a.join("/"))})}}exports.MP4Parser=u;
...
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer,t=this&&this.__awaiter||function(e,t,i,r){return new(i||(i=Promise))(function(a,s){function n(e){try{h(r.next(e))}catch(t){s(t)}}function o(e){try{h(r.throw(e))}catch(t){s(t)}}function h(e){e.done?a(e.value):new i(function(t){t(e.value)}).then(n,o)}h((r=r.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const i=require("assert"),r=require("token-types"),a=require("strtok3/lib/type"),s=require("debug"),n=require("../common/Util"),o=require("../id3v2/AbstractID3Parser"),h=require("./XingTag"),l=s("music-metadata:parser:mpeg"),f=1024,d={AudioObjectTypes:["AAC Main","AAC LC","AAC SSR","AAC LTP"],SamplingFrequencies:[96e3,88200,64e3,48e3,44100,32e3,24e3,22050,16e3,12e3,11025,8e3,7350,void 0,void 0,-1]},u=[void 0,["front-center"],["front-left","front-right"],["front-center","front-left","front-right"],["front-center","front-left","front-right","back-center"],["front-center","front-left","front-right","back-left","back-right"],["front-center","front-left","front-right","back-left","back-right","LFE-channel"],["front-center","front-left","front-right","side-left","side-right","back-left","back-right","LFE-channel"]];class c{constructor(e,t){this.versionIndex=n.default.getBitAllignedNumber(e,t+1,3,2),this.layer=c.LayerDescription[n.default.getBitAllignedNumber(e,t+1,5,2)],this.versionIndex>1&&0===this.layer?this.parseAdtsHeader(e,t):this.parseMpegHeader(e,t),this.isProtectedByCRC=!n.default.isBitSet(e,t+1,7)}calcDuration(e){return e*this.calcSamplesPerFrame()/this.samplingRate}calcSamplesPerFrame(){return c.samplesInFrameTable[1===this.version?0:1][this.layer]}calculateSideInfoLength(){if(3!==this.layer)return 2;if(3===this.channelModeIndex){if(1===this.version)return 17;if(2===this.version||2.5===this.version)return 9}else{if(1===this.version)return 32;if(2===this.version||2.5===this.version)return 17}}calcSlotSize(){return[null,4,1,1][this.layer]}parseMpegHeader(e,t){this.container="MPEG",this.bitrateIndex=n.default.getBitAllignedNumber(e,t+2,0,4),this.sampRateFreqIndex=n.default.getBitAllignedNumber(e,t+2,4,2),this.padding=n.default.isBitSet(e,t+2,6),this.privateBit=n.default.isBitSet(e,t+2,7),this.channelModeIndex=n.default.getBitAllignedNumber(e,t+3,0,2),this.modeExtension=n.default.getBitAllignedNumber(e,t+3,2,2),this.isCopyrighted=n.default.isBitSet(e,t+3,4),this.isOriginalMedia=n.default.isBitSet(e,t+3,5),this.emphasis=n.default.getBitAllignedNumber(e,t+3,7,2),this.version=c.VersionID[this.versionIndex],this.channelMode=c.ChannelMode[this.channelModeIndex],this.codec="mp"+this.layer;const i=this.calcBitrate();if(!i)throw new Error("Cannot determine bit-rate");if(this.bitrate=null===i?null:1e3*i,this.samplingRate=this.calcSamplingRate(),null==this.samplingRate)throw new Error("Cannot determine sampling-rate")}parseAdtsHeader(e,t){l("layer=0 => ADTS"),this.version=2===this.versionIndex?4:2,this.container="ADTS/MPEG-"+this.version;const i=n.default.getBitAllignedNumber(e,t+2,0,2);this.codec="AAC",this.codecProfile=d.AudioObjectTypes[i],l(`MPEG-4 audio-codec=${this.codec}`);const r=n.default.getBitAllignedNumber(e,t+2,2,4);this.samplingRate=d.SamplingFrequencies[r],l(`sampling-rate=${this.samplingRate}`);const a=n.default.getBitAllignedNumber(e,t+2,7,3);this.mp4ChannelConfig=u[a],l(`channel-config=${this.mp4ChannelConfig.join("+")}`),this.frameLength=n.default.getBitAllignedNumber(e,t+3,6,2)<<11}calcBitrate(){if(0===this.bitrateIndex)return null;if(15===this.bitrateIndex)return null;const e=this.version.toString()+this.layer;return c.bitrate_index[this.bitrateIndex][e]}calcSamplingRate(){return 3===this.sampRateFreqIndex?null:c.sampling_rate_freq_index[this.version][this.sampRateFreqIndex]}}c.SyncByte1=255,c.SyncByte2=224,c.VersionID=[2.5,null,2,1],c.LayerDescription=[0,3,2,1],c.ChannelMode=["stereo","joint_stereo","dual_channel","mono"],c.bitrate_index={1:{11:32,12:32,13:32,21:32,22:8,23:8},2:{11:64,12:48,13:40,21:48,22:16,23:16},3:{11:96,12:56,13:48,21:56,22:24,23:24},4:{11:128,12:64,13:56,21:64,22:32,23:32},5:{11:160,12:80,13:64,21:80,22:40,23:40},6:{11:192,12:96,13:80,21:96,22:48,23:48},7:{11:224,12:112,13:96,21:112,22:56,23:56},8:{11:256,12:128,13:112,21:128,22:64,23:64},9:{11:288,12:160,13:128,21:144,22:80,23:80},10:{11:320,12:192,13:160,21:160,22:96,23:96},11:{11:352,12:224,13:192,21:176,22:112,23:112},12:{11:384,12:256,13:224,21:192,22:128,23:128},13:{11:416,12:320,13:256,21:224,22:144,23:144},14:{11:448,12:384,13:320,21:256,22:160,23:160}},c.sampling_rate_freq_index={1:{0:44100,1:48e3,2:32e3},2:{0:22050,1:24e3,2:16e3},2.5:{0:11025,1:12e3,2:8e3}},c.samplesInFrameTable=[[0,384,1152,1152],[0,384,1152,576]];const m={len:4,get:(e,t)=>new c(e,t)};function g(e){return"V"+(100-e)/10}class p extends o.AbstractID3Parser{constructor(){super(...arguments),this.frameCount=0,this.syncFrameCount=-1,this.countSkipFrameData=0,this.totalAudioLength=0,this.bitrates=[],this.calculateEofDuration=!1,this.buf_frame_header=e.alloc(4),this.syncPeek={buf:e.alloc(f),len:0}}_parse(){return t(this,void 0,void 0,function*(){this.metadata.setFormat("lossless",!1);try{let t=!1;for(;!t;)yield this.sync(),t=yield this.parseAudioFrameHeader()}catch(e){if(e.message!==a.endOfFile)throw e;if(this.calculateEofDuration){const e=this.frameCount*this.samplesPerFrame;this.metadata.setFormat("numberOfSamples",e);const t=e/this.metadata.format.sampleRate;l(`Calculate duration at EOF: ${t} sec.`,t),this.metadata.setFormat("duration",t)}}})}finalize(){const e=this.metadata.format,t=this.metadata.native.hasOwnProperty("ID3v1");if(e.duration&&this.tokenizer.fileSize){const i=this.tokenizer.fileSize-this.mpegOffset-(t?128:0);e.codecProfile&&"V"===e.codecProfile[0]&&this.metadata.setFormat("bitrate",8*i/e.duration)}else if(this.tokenizer.fileSize&&"CBR"===e.codecProfile){const i=this.tokenizer.fileSize-this.mpegOffset-(t?128:0),r=Math.round(i/this.frame_size)*this.samplesPerFrame;this.metadata.setFormat("numberOfSamples",r);const a=r/e.sampleRate;l("Calculate CBR duration based on file size: %s",a),this.metadata.setFormat("duration",a)}}sync(){return t(this,void 0,void 0,function*(){let e=!1;for(;;){let t=0;if(this.syncPeek.len=yield this.tokenizer.peekBuffer(this.syncPeek.buf,0,f,this.tokenizer.position,!0),this.syncPeek.len<=256)throw new Error(a.endOfFile);if(0===this.syncPeek.len)throw new Error(a.endOfFile);for(;;){if(e&&224==(224&this.syncPeek.buf[t]))return this.buf_frame_header[0]=c.SyncByte1,this.buf_frame_header[1]=this.syncPeek.buf[t],yield this.tokenizer.ignore(t),l(`Sync at offset=${this.tokenizer.position-1}, frameCount=${this.frameCount}`),this.syncFrameCount===this.frameCount&&(l(`Re-synced MPEG stream, frameCount=${this.frameCount}`),this.frameCount=0,this.frame_size=0),void(this.syncFrameCount=this.frameCount);if(e=!1,-1===(t=this.syncPeek.buf.indexOf(c.SyncByte1,t))){if(this.syncPeek.len<this.syncPeek.buf.length)throw new Error(a.endOfFile);yield this.tokenizer.ignore(this.syncPeek.len);break}++t,e=!0}}})}parseAudioFrameHeader(){return t(this,void 0,void 0,function*(){let e;0===this.frameCount&&(this.mpegOffset=this.tokenizer.position-1),yield this.tokenizer.peekBuffer(this.buf_frame_header,1,3);try{e=m.get(this.buf_frame_header,0)}catch(a){return yield this.tokenizer.ignore(1),this.warnings.push("Parse error: "+a.message),!1}if(yield this.tokenizer.ignore(3),this.metadata.setFormat("dataformat",e.container),this.metadata.setFormat("encoder",e.codec),this.metadata.setFormat("lossless",!1),this.metadata.setFormat("sampleRate",e.samplingRate),e.version>=2&&0===e.layer)return this.parseAdts(e);this.metadata.setFormat("numberOfChannels","mono"===e.channelMode?1:2),this.metadata.setFormat("bitrate",e.bitrate),this.frameCount<2e5&&l("offset=%s MP%s bitrate=%s sample-rate=%s",this.tokenizer.position-4,e.layer,e.bitrate,e.samplingRate);const t=e.calcSlotSize();if(null===t)throw new Error("invalid slot_size");const i=e.calcSamplesPerFrame();l(`samples_per_frame=${i}`);const r=i/8*e.bitrate/e.samplingRate+(e.padding?t:0);if(this.frame_size=Math.floor(r),this.audioFrameHeader=e,this.frameCount++,this.bitrates.push(e.bitrate),1===this.frameCount)return this.offset=m.len,yield this.skipSideInformation(),!1;if(3===this.frameCount){if(this.areAllSame(this.bitrates)){if(this.samplesPerFrame=i,this.metadata.setFormat("codecProfile","CBR"),this.tokenizer.fileSize)return!0}else if(this.metadata.format.duration)return!0;if(!this.options.duration)return!0}return this.options.duration&&4===this.frameCount&&(this.samplesPerFrame=i,this.calculateEofDuration=!0),this.offset=4,e.isProtectedByCRC?(yield this.parseCrc(),!1):(yield this.skipSideInformation(),!1)})}parseAdts(i){return t(this,void 0,void 0,function*(){const t=e.alloc(3);yield this.tokenizer.readBuffer(t),i.frameLength+=n.default.getBitAllignedNumber(t,0,0,11),this.tokenizer.ignore(i.frameLength-7+1),this.frameCount++,this.totalAudioLength+=i.frameLength;const r=i.samplingRate/1024,a=8*(0===this.frameCount?0:this.totalAudioLength/this.frameCount)*r+.5;return this.metadata.setFormat("codecProfile",i.codecProfile),this.metadata.setFormat("bitrate",a),i.mp4ChannelConfig&&this.metadata.setFormat("numberOfChannels",i.mp4ChannelConfig.length),l(`size=${i.frameLength} bytes, bit-rate=${a}`),3===this.frameCount})}parseCrc(){return t(this,void 0,void 0,function*(){return this.crc=yield this.tokenizer.readNumber(r.INT16_BE),this.offset+=2,this.skipSideInformation()})}skipSideInformation(){return t(this,void 0,void 0,function*(){const e=this.audioFrameHeader.calculateSideInfoLength();yield this.tokenizer.readToken(new r.BufferType(e)),this.offset+=e,yield this.readXtraInfoHeader()})}readXtraInfoHeader(){return t(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(h.InfoTagHeaderTag);switch(this.offset+=h.InfoTagHeaderTag.len,e){case"Info":return this.metadata.setFormat("codecProfile","CBR"),this.readXingInfoHeader();case"Xing":const t=g((yield this.readXingInfoHeader()).vbrScale);return this.metadata.setFormat("codecProfile",t),null;case"Xtra":break;case"LAME":const i=yield this.tokenizer.readToken(h.LameEncoderVersion);return this.offset+=h.LameEncoderVersion.len,this.metadata.setFormat("tool","LAME "+i),yield this.skipFrameData(this.frame_size-this.offset),null}const t=this.frame_size-this.offset;return t<0?this.warnings.push("Frame "+this.frameCount+"corrupt: negative frameDataLeft"):yield this.skipFrameData(t),null})}readXingInfoHeader(){return t(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(h.XingInfoTag);if(this.offset+=h.XingInfoTag.len,this.metadata.setFormat("tool",n.default.stripNulls(e.encoder)),1==(1&e.headerFlags[3])){const t=this.audioFrameHeader.calcDuration(e.numFrames);return this.metadata.setFormat("duration",t),l("Get duration from Xing header: %s",this.metadata.format.duration),e}const t=this.frame_size-this.offset;return yield this.skipFrameData(t),e})}skipFrameData(e){return t(this,void 0,void 0,function*(){i.ok(e>=0,"frame-data-left cannot be negative"),yield this.tokenizer.readToken(new r.IgnoreType(e)),this.countSkipFrameData+=e})}areAllSame(e){const t=e[0];return e.every(e=>e===t)}}exports.MpegParser=p;
},{"assert":"g2FE","token-types":"1rOY","strtok3/lib/type":"2Fe+","debug":"j+D9","../common/Util":"5e0M","../id3v2/AbstractID3Parser":"Tc8M","./XingTag":"jtQL","buffer":"z1tx"}],"yr5a":[function(require,module,exports) {
...
},{"debug":"j+D9","assert":"g2FE","../../common/BasicParser":"O0hF","./StreamVersion8":"yr5a","../../apev2/APEv2Parser":"IhDz","../../common/FourCC":"P2sd"}],"6yVT":[function(require,module,exports) {
...
},{"debug":"j+D9","assert":"g2FE","../../common/BasicParser":"O0hF","./StreamVersion7":"6yVT","../../apev2/APEv2Parser":"IhDz","./BitReader":"qgDo"}],"dsOL":[function(require,module,exports) {
...
},{"debug":"j+D9","./Speex":"PMZJ","../vorbis/VorbisParser":"nYTK"}],"fxkA":[function(require,module,exports) {
"use strict";var e=this&&this.__awaiter||function(e,t,r,a){return new(r||(r=Promise))(function(s,i){function o(e){try{u(a.next(e))}catch(t){i(t)}}function n(e){try{u(a.throw(e))}catch(t){i(t)}}function u(e){e.done?s(e.value):new r(function(t){t(e.value)}).then(o,n)}u((a=a.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("token-types"),r=require("debug"),a=require("assert"),s=require("../common/Util"),i=require("../common/FourCC"),o=require("./vorbis/VorbisParser"),n=require("./opus/OpusParser"),u=require("./speex/SpeexParser"),g=require("../common/BasicParser"),p=r("music-metadata:parser:ogg");class c{static sum(e,t,r){let a=0;for(let s=t;s<t+r;++s)a+=e[s];return a}constructor(e){this.len=e.page_segments}get(e,t){return{totalPageSize:c.sum(e,t,this.len)}}}exports.SegmentTable=c;class h extends g.BasicParser{parse(){return e(this,void 0,void 0,function*(){p("pos=%s, parsePage()",this.tokenizer.position);try{let r;do{r=yield this.tokenizer.readToken(h.Header),a.strictEqual(r.capturePattern,"OggS","Ogg capture pattern"),this.header=r,this.pageNumber=r.pageSequenceNo,p("page#=%s, Ogg.id=%s",r.pageSequenceNo,r.capturePattern);const e=yield this.tokenizer.readToken(new c(r));p("totalPageSize=%s",e.totalPageSize);const s=yield this.tokenizer.readToken(new t.BufferType(e.totalPageSize));if(p("firstPage=%s, lastPage=%s, continued=%s",r.headerType.firstPage,r.headerType.lastPage,r.headerType.continued),r.headerType.firstPage){const e=new t.StringType(7,"ascii").get(s,0);switch(e){case"vorbis":p("Set page consumer to Ogg/Vorbis "),this.pageConsumer=new o.VorbisParser(this.metadata,this.options);break;case"OpusHea":p("Set page consumer to Ogg/Opus"),this.pageConsumer=new n.OpusParser(this.metadata,this.options,this.tokenizer);break;case"Speex  ":p("Set page consumer to Ogg/Speex"),this.pageConsumer=new u.SpeexParser(this.metadata,this.options,this.tokenizer);break;default:throw new Error("gg audio-codec not recognized (id="+e+")")}this.metadata.setFormat("dataformat","Ogg/"+this.pageConsumer.codecName)}this.pageConsumer.parsePage(r,s)}while(!r.headerType.lastPage)}catch(e){if("End-Of-File"===e.message)return;if(e.message.startsWith("FourCC")&&this.pageNumber>0)return this.warnings.push("Invalid FourCC ID, maybe last OGG-page is not marked with last-page flag"),this.pageConsumer.flush();throw e}})}}h.Header={len:27,get:(e,r)=>({capturePattern:i.FourCcToken.get(e,r),version:e.readUInt8(r+4),headerType:{continued:s.default.strtokBITSET.get(e,r+5,0),firstPage:s.default.strtokBITSET.get(e,r+5,1),lastPage:s.default.strtokBITSET.get(e,r+5,2)},absoluteGranulePosition:e.readIntLE(r+6,6),streamSerialNumber:t.UINT32_LE.get(e,r+14),pageSequenceNo:t.UINT32_LE.get(e,r+18),pageChecksum:t.UINT32_LE.get(e,r+22),page_segments:e.readUInt8(r+26)})},exports.OggParser=h;
},{"token-types":"1rOY","debug":"j+D9","assert":"g2FE","../common/Util":"5e0M","../common/FourCC":"P2sd","./vorbis/VorbisParser":"nYTK","./opus/OpusParser":"Ja40","./speex/SpeexParser":"D7fj","../common/BasicParser":"O0hF"}],"JdqU":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("token-types"),t=require("../common/FourCC");exports.Header={len:8,get:(e,r)=>({chunkID:t.FourCcToken.get(e,r),chunkSize:e.readUInt32LE(r+4)})};class r{constructor(e){this.tagHeader=e,this.len=e.chunkSize,this.len+=1&this.len}get(t,r){return new e.StringType(this.tagHeader.chunkSize,"ascii").get(t,r)}}exports.ListInfoTagValue=r;
},{"token-types":"1rOY","../common/FourCC":"P2sd"}],"gDSg":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("assert");var t;!function(e){e[e.PCM=1]="PCM",e[e.ADPCM=2]="ADPCM",e[e.IEEE_FLOAT=3]="IEEE_FLOAT",e[e.MPEG_ADTS_AAC=5632]="MPEG_ADTS_AAC",e[e.MPEG_LOAS=5634]="MPEG_LOAS",e[e.RAW_AAC1=255]="RAW_AAC1",e[e.DOLBY_AC3_SPDIF=146]="DOLBY_AC3_SPDIF",e[e.DVM=8192]="DVM",e[e.RAW_SPORT=576]="RAW_SPORT",e[e.ESST_AC3=577]="ESST_AC3",e[e.DRM=9]="DRM",e[e.DTS2=8193]="DTS2",e[e.MPEG=80]="MPEG"}(t=exports.WaveFormat||(exports.WaveFormat={}));class r{constructor(t){e.ok(t.chunkSize>=16,"16 for PCM."),this.len=t.chunkSize}get(e,t){return{wFormatTag:e.readUInt16LE(t),nChannels:e.readUInt16LE(t+2),nSamplesPerSec:e.readUInt32LE(t+4),nAvgBytesPerSec:e.readUInt32LE(t+8),nBlockAlign:e.readUInt16LE(t+12),wBitsPerSample:e.readUInt16LE(t+14)}}}exports.Format=r;class n{constructor(t){e.ok(t.chunkSize>=4,"minimum fact chunk size."),this.len=t.chunkSize}get(e,t){return{dwSampleLength:e.readUInt32LE(t)}}}exports.FactChunk=n;
},{"assert":"g2FE"}],"UqqU":[function(require,module,exports) {
"use strict";var e=this&&this.__awaiter||function(e,t,a,i){return new(a||(a=Promise))(function(r,n){function s(e){try{h(i.next(e))}catch(t){n(t)}}function o(e){try{h(i.throw(e))}catch(t){n(t)}}function h(e){e.done?r(e.value):new a(function(t){t(e.value)}).then(s,o)}h((i=i.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("strtok3/lib/type"),a=require("strtok3/lib/core"),i=require("token-types"),r=require("debug"),n=require("./RiffChunk"),s=require("./../wav/WaveChunk"),o=require("../id3v2/ID3v2Parser"),h=require("../common/Util"),d=require("../common/FourCC"),u=require("../common/BasicParser"),c=require("../id3v2/ID3Stream"),k=r("music-metadata:parser:RIFF");class m extends u.BasicParser{parse(){return e(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(n.Header);if(k(`pos=${this.tokenizer.position}, parse: chunkID=${e.chunkID}`),"RIFF"===e.chunkID)return this.parseRiffChunk().catch(e=>{if(e.message!==t.endOfFile)throw e})})}parseRiffChunk(){return e(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(d.FourCcToken);switch(this.metadata.setFormat("dataformat",e),e){case"WAVE":return this.readWaveChunk();default:throw new Error(`Unsupported RIFF format: RIFF/${e}`)}})}readWaveChunk(){return e(this,void 0,void 0,function*(){for(;;){const e=yield this.tokenizer.readToken(n.Header);switch(this.header=e,k(`pos=${this.tokenizer.position}, readChunk: chunkID=RIFF/WAVE/${e.chunkID}`),e.chunkID){case"LIST":yield this.parseListTag(e);break;case"fact":this.metadata.setFormat("lossless",!1),this.fact=yield this.tokenizer.readToken(new s.FactChunk(e));break;case"fmt ":const t=yield this.tokenizer.readToken(new s.Format(e));let r=s.WaveFormat[t.wFormatTag];r||(k("WAVE/non-PCM format="+t.wFormatTag),r="non-PCM ("+t.wFormatTag+")"),this.metadata.setFormat("dataformat","WAVE/"+r),this.metadata.setFormat("bitsPerSample",t.wBitsPerSample),this.metadata.setFormat("sampleRate",t.nSamplesPerSec),this.metadata.setFormat("numberOfChannels",t.nChannels),this.metadata.setFormat("bitrate",t.nBlockAlign*t.nSamplesPerSec*8),this.blockAlign=t.nBlockAlign;break;case"id3 ":case"ID3 ":const n=yield this.tokenizer.readToken(new i.BufferType(e.chunkSize)),h=new c.ID3Stream(n),d=a.fromStream(h);yield(new o.ID3v2Parser).parse(this.metadata,d,this.options);break;case"data":!1!==this.metadata.format.lossless&&this.metadata.setFormat("lossless",!0);const u=this.fact?this.fact.dwSampleLength:e.chunkSize/this.blockAlign;this.metadata.setFormat("numberOfSamples",u),this.metadata.setFormat("duration",u/this.metadata.format.sampleRate),this.metadata.setFormat("bitrate",this.metadata.format.numberOfChannels*this.blockAlign*this.metadata.format.sampleRate),yield this.tokenizer.ignore(e.chunkSize);break;default:k(`Ignore chunk: RIFF/${e.chunkID} of ${e.chunkSize} bytes`),this.warnings.push("Ignore chunk: RIFF/"+e.chunkID),yield this.tokenizer.ignore(e.chunkSize)}this.header.chunkSize%2==1&&(k("Read odd padding byte"),yield this.tokenizer.ignore(1))}})}parseListTag(t){return e(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(d.FourCcToken);switch(k("pos=%s, parseListTag: chunkID=RIFF/WAVE/LIST/%s",this.tokenizer.position,e),e){case"INFO":return this.parseRiffInfoTags(t.chunkSize-4);case"adtl":default:return this.warnings.push("Ignore chunk: RIFF/WAVE/LIST/"+e),k("Ignoring chunkID=RIFF/WAVE/LIST/"+e),this.tokenizer.ignore(t.chunkSize-4)}})}parseRiffInfoTags(t){return e(this,void 0,void 0,function*(){for(;t>=8;){const e=yield this.tokenizer.readToken(n.Header),a=new n.ListInfoTagValue(e),i=yield this.tokenizer.readToken(a);this.addTag(e.chunkID,h.default.stripNulls(i)),t-=8+a.len}if(0!==t)throw Error("Illegal remaining size: "+t)})}addTag(e,t){this.metadata.addTag("exif",e,t)}}exports.WaveParser=m;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("token-types"),t=require("../common/FourCC"),i=[6e3,8e3,9600,11025,12e3,16e3,22050,24e3,32e3,44100,48e3,64e3,88200,96e3,192e3,-1];class s{static isBitSet(e,t){return 1===s.getBitAllignedNumber(e,t,1)}static getBitAllignedNumber(e,t,i){return e>>>t&4294967295>>>32-i}}s.BlockHeaderToken={len:32,get:(l,o)=>{const n=e.UINT32_LE.get(l,o+24),r={BlockID:t.FourCcToken.get(l,o),blockSize:e.UINT32_LE.get(l,o+4),version:e.UINT16_LE.get(l,o+8),totalSamples:(e.UINT8.get(l,o+11)<<32)+e.UINT32_LE.get(l,o+12),blockIndex:(e.UINT8.get(l,o+10)<<32)+e.UINT32_LE.get(l,o+16),blockSamples:e.UINT32_LE.get(l,o+20),flags:{bitsPerSample:8*(1+s.getBitAllignedNumber(n,0,2)),isMono:s.isBitSet(n,2),isHybrid:s.isBitSet(n,3),isJointStereo:s.isBitSet(n,4),crossChannel:s.isBitSet(n,5),hybridNoiseShaping:s.isBitSet(n,6),floatingPoint:s.isBitSet(n,7),samplingRate:i[s.getBitAllignedNumber(n,23,4)],isDSD:s.isBitSet(n,31)},crc:new e.BufferType(4).get(l,o+28)};return r.flags.isDSD&&(r.totalSamples*=8),r}},s.MetadataIdToken={len:1,get:(e,t)=>({functionId:s.getBitAllignedNumber(e[t],0,6),isOptional:s.isBitSet(e[t],5),isOddSize:s.isBitSet(e[t],6),largeBlock:s.isBitSet(e[t],7)})},exports.WavPack=s;
},{"token-types":"1rOY","../common/FourCC":"P2sd"}],"0DiC":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer,a=this&&this.__awaiter||function(e,a,t,i){return new(t||(t=Promise))(function(o,r){function s(e){try{l(i.next(e))}catch(a){r(a)}}function n(e){try{l(i.throw(e))}catch(a){r(a)}}function l(e){e.done?o(e.value):new t(function(a){a(e.value)}).then(s,n)}l((i=i.apply(e,a||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("token-types"),i=require("assert"),o=require("../apev2/APEv2Parser"),r=require("../common/FourCC"),s=require("../common/BasicParser"),n=require("./WavPackToken"),l=require("debug"),d=l("music-metadata:parser:WavPack");class c extends s.BasicParser{parse(){return a(this,void 0,void 0,function*(){return this.audioDataSize=0,yield this.parseWavPackBlocks(),o.APEv2Parser.parseTagHeader(this.metadata,this.tokenizer,this.options)})}parseWavPackBlocks(){return a(this,void 0,void 0,function*(){do{if("wvpk"!==(yield this.tokenizer.peekToken(r.FourCcToken)))break;const e=yield this.tokenizer.readToken(n.WavPack.BlockHeaderToken);i.strictEqual(e.BlockID,"wvpk","WavPack Block-ID"),d(`WavPack header blockIndex=${e.blockIndex}, len=${n.WavPack.BlockHeaderToken.len}`),0!==e.blockIndex||this.metadata.format.dataformat||(this.metadata.setFormat("dataformat","WavPack"),this.metadata.setFormat("lossless",!e.flags.isHybrid),this.metadata.setFormat("bitsPerSample",e.flags.bitsPerSample),e.flags.isDSD||(this.metadata.setFormat("sampleRate",e.flags.samplingRate),this.metadata.setFormat("duration",e.totalSamples/e.flags.samplingRate)),this.metadata.setFormat("numberOfChannels",e.flags.isMono?1:2),this.metadata.setFormat("numberOfSamples",e.totalSamples),this.metadata.setFormat("codecProfile",e.flags.isDSD?"DSD":"PCM"));const a=e.blockSize-(n.WavPack.BlockHeaderToken.len-8);0===e.blockIndex?yield this.parseMetadataSubBlock(e,a):yield this.tokenizer.ignore(a),e.blockSamples>0&&(this.audioDataSize+=e.blockSize)}while(!this.tokenizer.fileSize||this.tokenizer.fileSize-this.tokenizer.position>=n.WavPack.BlockHeaderToken.len);this.metadata.setFormat("bitrate",8*this.audioDataSize/this.metadata.format.duration)})}parseMetadataSubBlock(o,r){return a(this,void 0,void 0,function*(){for(;r>n.WavPack.MetadataIdToken.len;){const a=yield this.tokenizer.readToken(n.WavPack.MetadataIdToken),s=yield this.tokenizer.readNumber(a.largeBlock?t.UINT24_LE:t.UINT8),l=e.alloc(2*s-(a.isOddSize?1:0));switch(yield this.tokenizer.readBuffer(l,0,l.length),d(`Metadata Sub-Blocks functionId=0x${a.functionId.toString(16)}, id.largeBlock=${a.largeBlock},data-size=${l.length}`),a.functionId){case 0:break;case 14:d("ID_DSD_BLOCK");const e=1<<l.readUInt8(0),t=o.flags.samplingRate*e*8;i.ok(o.flags.isDSD,"Only expect DSD block if DSD-flag is set"),this.metadata.setFormat("sampleRate",t),this.metadata.setFormat("duration",o.totalSamples/t);break;case 36:d("ID_ALT_TRAILER: trailer for non-wav files");break;case 38:this.metadata.setFormat("audioMD5",l);break;case 47:d(`ID_BLOCK_CHECKSUM: checksum=${l.toString("hex")}`);break;default:d(`Ignore unsupported meta-sub-block-id functionId=0x${a.functionId.toString(16)}`)}r-=n.WavPack.MetadataIdToken.len+(a.largeBlock?t.UINT24_LE.len:t.UINT8.len)+2*s,d(`remainingLength=${r}`),a.isOddSize&&this.tokenizer.ignore(1)}i.strictEqual(r,0,"metadata-sub-block should fit it remaining length")})}}exports.WavPackParser=c;
},{"token-types":"1rOY","assert":"g2FE","../apev2/APEv2Parser":"IhDz","../common/FourCC":"P2sd","../common/BasicParser":"O0hF","./WavPackToken":"aBWN","debug":"j+D9","buffer":"z1tx"}],"kASw":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("token-types"),n=require("../common/FourCC");var t;exports.ChunkHeader={len:12,get:(t,o)=>({id:n.FourCcToken.get(t,o),size:e.UINT64_LE.get(t,o+4)})},exports.DsdChunk={len:16,get:(n,t)=>({fileSize:e.INT64_LE.get(n,t),metadataPointer:e.INT64_LE.get(n,t+8)})},function(e){e[e.mono=1]="mono",e[e.stereo=2]="stereo",e[e.channels=3]="channels",e[e.quad=4]="quad",e[e["4 channels"]=5]="4 channels",e[e["5 channels"]=6]="5 channels",e[e["5.1 channels"]=7]="5.1 channels"}(t=exports.ChannelType||(exports.ChannelType={})),exports.FormatChunk={len:40,get:(n,t)=>({formatVersion:e.INT32_LE.get(n,t),formatID:e.INT32_LE.get(n,t+4),channelType:e.INT32_LE.get(n,t+8),channelNum:e.INT32_LE.get(n,t+12),samplingFrequency:e.INT32_LE.get(n,t+16),bitsPerSample:e.INT32_LE.get(n,t+20),sampleCount:e.INT64_LE.get(n,t+24),blockSizePerChannel:e.INT32_LE.get(n,t+32)})};
},{"token-types":"1rOY","../common/FourCC":"P2sd"}],"PXkK":[function(require,module,exports) {
"use strict";var e=this&&this.__awaiter||function(e,t,a,i){return new(a||(a=Promise))(function(r,s){function n(e){try{u(i.next(e))}catch(t){s(t)}}function o(e){try{u(i.throw(e))}catch(t){s(t)}}function u(e){e.done?r(e.value):new a(function(t){t(e.value)}).then(n,o)}u((i=i.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("../id3v2/AbstractID3Parser"),a=require("assert"),i=require("debug"),r=require("./DsfChunk"),s=require("../id3v2/ID3v2Parser"),n=i("music-metadata:parser:DSF");class o extends t.AbstractID3Parser{_parse(){return e(this,void 0,void 0,function*(){const e=this.tokenizer.position,t=yield this.tokenizer.readToken(r.ChunkHeader);a.strictEqual(t.id,"DSD ","Invalid chunk signature"),this.metadata.setFormat("dataformat","DSF"),this.metadata.setFormat("lossless",!0);const i=yield this.tokenizer.readToken(r.DsdChunk);if(0!==i.metadataPointer)return n(`expect ID3v2 at offset=${i.metadataPointer}`),yield this.parseChunks(i.fileSize-t.size),yield this.tokenizer.ignore(i.metadataPointer-this.tokenizer.position-e),(new s.ID3v2Parser).parse(this.metadata,this.tokenizer,this.options);n("No ID3v2 tag present")})}parseChunks(t){return e(this,void 0,void 0,function*(){for(;t>=r.ChunkHeader.len;){const e=yield this.tokenizer.readToken(r.ChunkHeader);switch(n(`Parsing chunk name=${e.id} size=${e.size}`),e.id){case"fmt ":const t=yield this.tokenizer.readToken(r.FormatChunk);this.metadata.setFormat("numberOfChannels",t.channelNum),this.metadata.setFormat("sampleRate",t.samplingFrequency),this.metadata.setFormat("bitsPerSample",t.bitsPerSample),this.metadata.setFormat("numberOfSamples",t.sampleCount),this.metadata.setFormat("duration",t.sampleCount/t.samplingFrequency);const a=t.bitsPerSample*t.samplingFrequency*t.channelNum;return void this.metadata.setFormat("bitrate",a);default:this.tokenizer.ignore(e.size-r.ChunkHeader.len)}t-=e.size}})}}exports.DsfParser=o;
},{"../id3v2/AbstractID3Parser":"Tc8M","assert":"g2FE","debug":"j+D9","./DsfChunk":"kASw","../id3v2/ID3v2Parser":"pIqu"}],"xY5O":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});const e=require("token-types"),r=require("../common/FourCC");exports.ChunkHeader={len:12,get:(t,o)=>({chunkID:r.FourCcToken.get(t,o),chunkSize:e.INT64_BE.get(t,o+4)})};
},{"token-types":"1rOY","../common/FourCC":"P2sd"}],"xpEd":[function(require,module,exports) {
"use strict";var e=this&&this.__awaiter||function(e,t,n,i){return new(n||(n=Promise))(function(r,a){function s(e){try{h(i.next(e))}catch(t){a(t)}}function o(e){try{h(i.throw(e))}catch(t){a(t)}}function h(e){e.done?r(e.value):new n(function(t){t(e.value)}).then(s,o)}h((i=i.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("assert"),n=require("token-types"),i=require("debug"),r=require("../common/FourCC"),a=require("../common/BasicParser"),s=require("../id3v2/ID3Stream"),o=require("./DsdiffToken"),h=require("strtok3/lib/core"),d=require("../id3v2/ID3v2Parser"),u=i("music-metadata:parser:aiff");class k extends a.BasicParser{parse(){return e(this,void 0,void 0,function*(){const e=yield this.tokenizer.readToken(o.ChunkHeader);t.strictEqual(e.chunkID,"FRM8");const n=(yield this.tokenizer.readToken(r.FourCcToken)).trim();switch(n){case"DSD":return this.metadata.setFormat("dataformat",`DSDIFF/${n}`),this.metadata.setFormat("lossless",!0),this.readFmt8Chunks(e.chunkSize-r.FourCcToken.len);default:throw Error(`Unsupported DSDIFF type: ${n}`)}})}readFmt8Chunks(t){return e(this,void 0,void 0,function*(){for(;t>=o.ChunkHeader.len;){const e=yield this.tokenizer.readToken(o.ChunkHeader);u(`Chunk id=${e.chunkID}`),yield this.readData(e),t-=o.ChunkHeader.len+e.chunkSize}})}readData(i){return e(this,void 0,void 0,function*(){u(`Reading data of chunk[ID=${i.chunkID}, size=${i.chunkSize}]`);const e=this.tokenizer.position;switch(i.chunkID.trim()){case"FVER":const e=yield this.tokenizer.readToken(n.UINT32_LE);u(`DSDIFF version=${e}`);break;case"PROP":const a=yield this.tokenizer.readToken(r.FourCcToken);t.strictEqual(a,"SND "),yield this.handleSoundPropertyChunks(i.chunkSize-r.FourCcToken.len);break;case"ID3":const o=yield this.tokenizer.readToken(new n.BufferType(i.chunkSize)),k=new s.ID3Stream(o),c=h.fromStream(k);yield(new d.ID3v2Parser).parse(this.metadata,c,this.options);break;default:u(`Ignore chunk[ID=${i.chunkID}, size=${i.chunkSize}]`);break;case"DSD":this.metadata.setFormat("numberOfSamples",8*i.chunkSize/this.metadata.format.numberOfChannels),this.metadata.setFormat("duration",this.metadata.format.numberOfSamples/this.metadata.format.sampleRate)}const a=i.chunkSize-(this.tokenizer.position-e);a>0&&(u(`After Parsing chunk, remaining ${a} bytes`),yield this.tokenizer.ignore(a))})}handleSoundPropertyChunks(t){return e(this,void 0,void 0,function*(){for(u(`Parsing sound-property-chunks, remainingSize=${t}`);t>0;){const e=yield this.tokenizer.readToken(o.ChunkHeader);u(`Sound-property-chunk[ID=${e.chunkID}, size=${e.chunkSize}]`);const i=this.tokenizer.position;switch(e.chunkID.trim()){case"FS":const t=yield this.tokenizer.readToken(n.UINT32_BE);this.metadata.setFormat("sampleRate",t);break;case"CHNL":const i=yield this.tokenizer.readToken(n.UINT16_BE);this.metadata.setFormat("numberOfChannels",i),yield this.handleChannelChunks(e.chunkSize-n.UINT16_BE.len);break;case"CMPR":const a=(yield this.tokenizer.readToken(r.FourCcToken)).trim(),s=yield this.tokenizer.readToken(n.UINT8),o=yield this.tokenizer.readToken(new n.StringType(s,"ascii"));"DSD"===a&&(this.metadata.setFormat("lossless",!0),this.metadata.setFormat("bitsPerSample",1)),this.metadata.setFormat("encoder",`${a} (${o})`);break;case"ABSS":const h=yield this.tokenizer.readToken(n.UINT16_BE),d=yield this.tokenizer.readToken(n.UINT8),k=yield this.tokenizer.readToken(n.UINT8),c=yield this.tokenizer.readToken(n.UINT32_BE);u(`ABSS ${h}:${d}:${k}.${c}`);break;case"LSCO":const m=yield this.tokenizer.readToken(n.UINT16_BE);u(`LSCO lsConfig=${m}`);break;case"COMT":default:u(`Unknown sound-property-chunk[ID=${e.chunkID}, size=${e.chunkSize}]`),yield this.tokenizer.ignore(e.chunkSize)}const a=e.chunkSize-(this.tokenizer.position-i);a>0&&(u(`After Parsing sound-property-chunk ${e.chunkSize}, remaining ${a} bytes`),yield this.tokenizer.ignore(a)),t-=o.ChunkHeader.len+e.chunkSize,u(`Parsing sound-property-chunks, remainingSize=${t}`)}if(this.metadata.format.lossless&&this.metadata.format.sampleRate&&this.metadata.format.numberOfChannels&&this.metadata.format.bitsPerSample){const e=this.metadata.format.sampleRate*this.metadata.format.numberOfChannels*this.metadata.format.bitsPerSample;this.metadata.setFormat("bitrate",e)}})}handleChannelChunks(t){return e(this,void 0,void 0,function*(){u(`Parsing channel-chunks, remainingSize=${t}`);const e=[];for(;t>=r.FourCcToken.len;){const n=yield this.tokenizer.readToken(r.FourCcToken);u(`Channel[ID=${n}]`),e.push(n),t-=r.FourCcToken.len}return u(`Channels: ${e.join(", ")}`),e})}}exports.DsdiffParser=k;
},{"assert":"g2FE","token-types":"1rOY","debug":"j+D9","../common/FourCC":"P2sd","../common/BasicParser":"O0hF","../id3v2/ID3Stream":"Zy6X","./DsdiffToken":"xY5O","strtok3/lib/core":"tvmF","../id3v2/ID3v2Parser":"pIqu"}],"5YKB":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
var e=require("buffer").Buffer,r=this&&this.__awaiter||function(e,r,a,s){return new(a||(a=Promise))(function(t,c){function n(e){try{u(s.next(e))}catch(r){c(r)}}function i(e){try{u(s.throw(e))}catch(r){c(r)}}function u(e){e.done?t(e.value):new a(function(r){r(e.value)}).then(n,i)}u((s=s.apply(e,r||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const a=require("file-type"),s=require("media-typer"),t=require("debug"),c=require("./common/MetadataCollector"),n=require("./aiff/AiffParser"),i=require("./apev2/APEv2Parser"),u=require("./asf/AsfParser"),o=require("./flac/FlacParser"),f=require("./mp4/MP4Parser"),p=require("./mpeg/MpegParser"),m=require("./musepack"),d=require("./ogg/OggParser"),g=require("./riff/WaveParser"),w=require("./wavpack/WavPackParser"),v=require("./dsf/DsfParser"),P=require("./dsdiff/DsdiffParser"),l=t("music-metadata:parser:factory");class y{constructor(){this.warning=[]}static parse(s,t,c){return r(this,void 0,void 0,function*(){let r=y.getParserIdForMimeType(t)||y.getParserIdForExtension(t);if(!r){l("No parser found for MIME-type / extension: "+t);const n=e.alloc(4100);yield s.peekBuffer(n,0,n.byteLength,s.position,!0);const i=a(n);if(!i)throw new Error("Failed to guess MIME-type");if(l(`Guessed file type is mime=${i.mime}, extension=${i.ext}`),!(r=y.getParserIdForMimeType(i.mime)))throw new Error("Guessed MIME-type not supported: "+i.mime);return this._parse(s,r,c)}return this._parse(s,r,c)})}static getParserIdForExtension(e){if(!e)return;switch(this.getExtension(e).toLocaleLowerCase()||e){case".mp2":case".mp3":case".m2a":case".aac":return"mpeg";case".ape":return"apev2";case".mp4":case".m4a":case".m4b":case".m4pa":case".m4v":case".m4r":case".3gp":return"mp4";case".wma":case".wmv":case".asf":return"asf";case".flac":return"flac";case".ogg":case".ogv":case".oga":case".ogm":case".ogx":case".opus":case".spx":return"ogg";case".aif":case".aiff":case".aifc":return"aiff";case".wav":return"riff";case".wv":case".wvp":return"wavpack";case".mpc":return"musepack";case".dsf":return"dsf";case".dff":return"dsdiff"}}static loadParser(e,a){return r(this,void 0,void 0,function*(){switch(e){case"aiff":return new n.AIFFParser;case"apev2":return new i.APEv2Parser;case"asf":return new u.AsfParser;case"dsf":return new v.DsfParser;case"dsdiff":return new P.DsdiffParser;case"flac":return new o.FlacParser;case"mp4":return new f.MP4Parser;case"mpeg":return new p.MpegParser;case"musepack":return new m.default;case"ogg":return new d.OggParser;case"riff":return new g.WaveParser;case"wavpack":return new w.WavPackParser;default:throw new Error(`Unknown parser type: ${e}`)}})}static _parse(e,a,s={}){return r(this,void 0,void 0,function*(){const r=yield y.loadParser(a,s),t=new c.MetadataCollector(s);return yield r.init(t,e,s).parse(),t.toCommonMetadata()})}static getExtension(e){const r=e.lastIndexOf(".");return-1===r?"":e.slice(r)}static getParserIdForMimeType(e){let r;try{r=s.parse(e)}catch(t){return void l(`Invalid MIME-type: ${e}`)}const a=0===r.subtype.indexOf("x-")?r.subtype.substring(2):r.subtype;switch(r.type){case"audio":switch(a){case"mp3":case"mpeg":return"mpeg";case"flac":return"flac";case"ape":case"monkeys-audio":return"apev2";case"mp4":case"aac":case"aacp":case"m4a":return"mp4";case"ogg":case"opus":case"speex":return"ogg";case"ms-wma":case"ms-wmv":case"ms-asf":return"asf";case"aiff":case"aif":case"aifc":return"aiff";case"vnd.wave":case"wav":case"wave":return"riff";case"wavpack":return"wavpack";case"musepack":return"musepack";case"dsf":return"dsf"}break;case"video":switch(a){case"ms-asf":case"ms-wmv":return"asf";case"m4v":case"mp4":return"mp4";case"ogg":return"ogg"}break;case"application":switch(a){case"vnd.ms-asf":return"asf";case"ogg":return"ogg"}}}}exports.ParserFactory=y;
},{"file-type":"gPQA","media-typer":"atBn","debug":"j+D9","./common/MetadataCollector":"34Xp","./aiff/AiffParser":"C2dR","./apev2/APEv2Parser":"IhDz","./asf/AsfParser":"EvYH","./flac/FlacParser":"lnZi","./mp4/MP4Parser":"eyoP","./mpeg/MpegParser":"7/3S","./musepack":"dsOL","./ogg/OggParser":"fxkA","./riff/WaveParser":"UqqU","./wavpack/WavPackParser":"0DiC","./dsf/DsfParser":"PXkK","./dsdiff/DsdiffParser":"xpEd","buffer":"z1tx"}],"0Pvp":[function(require,module,exports) {
...
"use strict";var e=this&&this.__awaiter||function(e,t,i,n){return new(i||(i=Promise))(function(s,d){function r(e){try{o(n.next(e))}catch(t){d(t)}}function a(e){try{o(n.throw(e))}catch(t){d(t)}}function o(e){e.done?s(e.value):new i(function(t){t(e.value)}).then(r,a)}o((n=n.apply(e,t||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const t=require("debug"),i=require("stream"),n=t("readable-web-to-node-stream");class s extends i.Readable{constructor(e){super(),this.bytesRead=0,this.released=!1,this.reader=e.getReader()}_read(){return e(this,void 0,void 0,function*(){if(this.released)return;this.pendingRead=this.reader.read();const e=yield this.pendingRead;delete this.pendingRead,e.done||this.released?this.push(null):(this.bytesRead+=e.value.length,this.push(e.value))})}waitForReadToComplete(){return e(this,void 0,void 0,function*(){this.pendingRead&&(yield this.pendingRead)})}close(){return e(this,void 0,void 0,function*(){n("close()"),yield this.syncAndRelease()})}syncAndRelease(){return e(this,void 0,void 0,function*(){n("syncAndRelease()"),this.released=!0,yield this.waitForReadToComplete(),yield this.reader.releaseLock()})}}exports.ReadableWeToNodeStream=s;
},{"debug":"j+D9","stream":"17Yv"}],"ugmL":[function(require,module,exports) {
...
"use strict";var e=this&&this.__awaiter||function(e,r,t,o){return new(t||(t=Promise))(function(a,n){function s(e){try{u(o.next(e))}catch(r){n(r)}}function i(e){try{u(o.throw(e))}catch(r){n(r)}}function u(e){e.done?a(e.value):new t(function(r){r(e.value)}).then(s,i)}u((o=o.apply(e,r||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0});const r=require("debug"),t=require("music-metadata/lib/core"),o=require("readable-web-to-node-stream"),a=require("typedarray-to-buffer"),n=r("music-metadata-browser:main");function s(r,t,a){return e(this,void 0,void 0,function*(){const e=new o.ReadableWeToNodeStream(r),s=yield exports.parseNodeStream(e,t,a);return n(`Completed parsing from stream bytesRead=${e.bytesRead} / fileSize=${a&&a.fileSize?a.fileSize:"?"}`),yield e.close(),s})}function i(e,r){return d(e).then(o=>t.parseBuffer(o,e.type,r))}function u(r,t){return e(this,void 0,void 0,function*(){const e=yield fetch(r),o=e.headers.get("Content-Type"),a=[];if(e.headers.forEach(e=>{a.push(e)}),e.ok){if(e.body){const r=yield this.parseReadableStream(e.body,o,t);return n("Closing HTTP-readable-stream..."),yield e.body.cancel(),n("HTTP-readable-stream closed."),r}return this.parseBlob(yield e.blob(),t)}throw new Error(`HTTP error status=${e.status}: ${e.statusText}`)})}function d(e){return new Promise((r,t)=>{const o=new FileReader;o.onloadend=(e=>{let t=e.target.result;t instanceof ArrayBuffer&&(t=a(new Uint8Array(e.target.result))),r(t)}),o.onerror=(e=>{t(new Error(e.type))}),o.onabort=(e=>{t(new Error(e.type))}),o.readAsArrayBuffer(e)})}exports.parseNodeStream=t.parseStream,exports.parseReadableStream=s,exports.parseBuffer=t.parseBuffer,exports.parseBlob=i,exports.fetchFromUrl=u,exports.parseFromTokenizer=t.parseFromTokenizer,exports.orderTags=t.orderTags,exports.ratingToStars=t.ratingToStars;
